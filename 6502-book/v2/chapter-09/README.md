...
Our `main.cpp` executes the full interactive GUI runtime environment in an OS window! You can type live into the emulator, and see your input rendered instantly on the emulated Apple ][ screen.
