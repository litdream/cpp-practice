...
Our `main.cpp` executes the system boot sequence, clocks the virtual CPU for sufficient cycles to allow firmware initialization to stabilize, and actually renders the iconic `Apple ][` monitor banner into an SDL2 window on your screen for you to see!
